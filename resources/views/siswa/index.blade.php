    ...
    <div class="ml-64 p-10 min-h-screen bg-gray-50">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('siswa.create') }}"
                class="bg-black text-white px-6 py-3 rounded-lg font-bold text-sm hover:bg-gray-800 transition shadow-lg">
                + Tambah Siswa
            </a>
        </div>
            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="p-4">
                            <span
                                class="bg-gray-100 text-gray-600 text-xs font-bold px-2 py-1 rounded border border-gray-200">
                                {{ $s->id_kelas }}
                            </span>
                        </td>
